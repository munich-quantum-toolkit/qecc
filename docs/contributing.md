...
Once everything is in order, navigate to the [Releases page](https://github.com/munich-quantum-toolkit/qecc/releases) on GitHub, edit the release draft if necessary, and publish the release.
