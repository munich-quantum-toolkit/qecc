...
[pull requests](https://github.com/munich-quantum-toolkit/qecc/pulls).
...
- 🐛 Report bugs:
  ...
  <https://github.com/munich-quantum-toolkit/qecc/issues>.
...
changes for MQT QECC, you can remove the {code}`minor` or {code}`major`
label from the PR.
