...
def test_plot_lattice_paths():
    ...
    g = lat.G
    vdp_dict: dict[tuple[int,int] | tuple[tuple[int, int], tuple[int, int]], list[tuple[int, int]]] = {(2, 5): [(2, 5), (1, 5), (1, 4), (0, 4), (0, 3)]} #only one path to a factory
    factories = [(0,3)]
    size = (3,3)
...
def test_parallel_cnot():
    ...
    vdp_layers_ref = [{((4, 10), (4, 9)): [(4, 10), (5, 10), (5, 9), (5, 8), (4, 8), (4, 9)],
