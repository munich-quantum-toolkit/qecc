...
from mqt.qecc.circuit_synthesis.elimination import EliminationConfig, eliminate, is_identity, get_candidate_transvections
...
def non_css_config() -> EliminationConfig:
    ...
    return EliminationConfig(
        termination_criterion=is_identity,
...
def test_eliminate(tableau_matrix: StabilizerTableau, identity_tableau: StabilizerTableau, non_css_config: EliminationConfig, request) -> None:
