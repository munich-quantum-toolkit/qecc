...
def standard_form_prep_circuit(code: CSSCode, zero_state: bool = True) -> FaultyStatePrepCircuit:
    ...
    for pivot, trgts in cnots:
        qc.h(pivot)
        qc.cx(pivot, trgts)
    return FaultyStatePrepCircuit(qc, code.x_distance // 2, code.z_distance // 2)
