...
#     """For terminal P: R2(P) is permutation, so for each output qubit i there is exactly one input qubit j with det(F_ij)=1. Store that j and the 2×2 block F_ij.
#     """
#     n = P.shape[0] // 2
#     R2 = _det_fij(P)
...
#     """If perm_out_to_in[i]=j means 'output i comes from input j', then to realize it as a wire permutation you need the inverse mapping input->output.
#     """
