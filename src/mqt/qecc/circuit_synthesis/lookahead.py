...
class LookaheadCandidateGenerator(CandidateGenerator):
    ...
    def _create_lookahead_config(self, initial_filter_state: list | None) -> EliminationConfig:
        """Create a fresh lookahead configuration for recursive simulation.

        Args:
            initial_filter_state: Initial state of filters to copy.

        Returns:
            A new EliminationConfig with fresh generator and filters.
        """
        fresh_base_filters = (
